...
class LampiToggle(ToggleButton):
    ...
    def on_accent_color(self, instance: "LampiToggle",
    ...
    def on_state(self, instance: "LampiToggle", value: str) -> None:
        self._update_state_color_async()

    def _update_state_color_async(self) -> None:
    ...
    def _update_state_color(self, *args: Any, **kwargs: Any) -> None:
        if self.state == 'down':
